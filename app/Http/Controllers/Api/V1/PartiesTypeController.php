...
class PartiesTypeController extends PARTIETYPE_HELPER
{
    ...
    #AJOUT D'UN PRODUIT 
    function TypeCreate(Request $request)
    {
        ...
        $validator = $this->TypeCreate_Validator($request->all());
    ...
    function _TypeRetrieve(Request $request, $id)
    {
        #VERIFICATION DE LA METHOD
        if ($this->methodValidation($request->method(), "GET") == False) {
            #RENVOIE D'ERREURE VIA **sendError** DE LA CLASS BASE_HELPER HERITEE PAR USER_HELPER
        ...
        return $this->typeretrieve($id);
    }
   #MODIFIER UN PRODUIT
   function _UpdateType(Request $request,$id)
   {
       #VERIFICATION DE LA METHOD
       if ($this->methodValidation($request->method(), "POST") == False) {
           #RENVOIE D'ERREURE VIA **sendError** DE LA CLASS BASE_HELPER HERITEE PAR USER_HELPER
    ...
    //    }
       ...
       return $this->updatetype($request,$id);
   }
   #SUPPRIMER UN PRODUIT
     function _DeleteType(Request $request,$id)
   {
       #VERIFICATION DE LA METHOD
       if ($this->methodValidation($request->method(), "POST") == False) {
           #RENVOIE D'ERREURE VIA **sendError** DE LA CLASS BASE_HELPER HERITEE PAR USER_HELPER
       ...
       #RECUPERATION D'UN PRODUIT VIA SON **id**
       return $this->deletetype($request,$id);
   }
