...
class AvocatController extends AVOCAT_HELPER
{
    ...
    #AJOUT D'UN CATEGORY 
    function AvocatCreate(Request $request)
    {
        ...
        $validator = $this->AvocatCreate_Validator($request->all());
        ...
        return $this->createAvocat($request);
    }

    #GET ALL PRODUCTS
    function Avocat(Request $request)
    {
        #VERIFICATION DE LA METHOD
    ...
    function _AvocatRetrieve(Request $request, $id)
    {
        #VERIFICATION DE LA METHOD
        if ($this->methodValidation($request->method(), "GET") == False) {
            #RENVOIE D'ERREURE VIA **sendError** DE LA CLASS BASE_HELPER HERITEE PAR USER_HELPER
        ...
        return $this->Avocatretrieve($id);
    }
   #MODIFIER UN PRODUIT
   function _UpdateAvocat(Request $request,$id)
   {
       #VERIFICATION DE LA METHOD
       if ($this->methodValidation($request->method(), "POST") == False) {
           #RENVOIE D'ERREURE VIA **sendError** DE LA CLASS BASE_HELPER HERITEE PAR USER_HELPER
    ...
    //    }
       ...
       return $this->updateavocat($request,$id);
   }
   #SUPPRIMER UN PRODUIT
     function _DeleteAvocat(Request $request,$id)
   {
       #VERIFICATION DE LA METHOD
       if ($this->methodValidation($request->method(), "POST") == False) {
           #RENVOIE D'ERREURE VIA **sendError** DE LA CLASS BASE_HELPER HERITEE PAR USER_HELPER
       ...
       #RECUPERATION D'UN PRODUIT VIA SON **id**
       return $this->deleteavocat($request,$id);
   }
