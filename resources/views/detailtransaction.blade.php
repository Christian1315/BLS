            ...
            <div class="col-lg-6 p-4">
                <fieldset style="border: solid lightblue;" class="p-3 shadow-lg">
                    ...
                    <div class="row">
                        ...
                        <div class=" col-md-4">
                            <form action="{{ route('downloadTransaction', ['id' => $transaction->id]) }}" method="post">
                                @csrf
                                <button type="submit" class="btt" style="background-color: #0F84AB; color:white;">Télécharger</button>
                            </form>
                        </div>
                    </div>
                </fieldset>
